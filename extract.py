...
data_dir = r"C:\\Users\\lapde\\OneDrive - Solent University\\Desktop\\my_final_codes\\Dataset"
...
for gesture in gestures:
    ...
    for video_file in os.listdir(gesture_dir):
        ...
        while cap.isOpened():
            ...
            colored_image, results = mediapipe_detection(resized_colored_frame, holistic)
            ...
            if cnt == 5:
                colored_image_file_path = os.path.join(gesture_output_dir, f"colored_{os.path.splitext(video_file)[0]}_{frame_count}_image.png")
                cv2.imwrite(colored_image_file_path, grayscale_image)
                cnt = 0
                continue
            cnt += 1
